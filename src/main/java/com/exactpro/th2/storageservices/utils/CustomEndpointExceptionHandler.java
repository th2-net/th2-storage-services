...
public class CustomEndpointExceptionHandler implements ExceptionHandler<CustomEndpointException, HttpResponse> {

    @Override
    public HttpResponse handle(HttpRequest request, CustomEndpointException exception) {
